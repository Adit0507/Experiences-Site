...
const Navbar = () => {
  ...
  return (
    <div className="absolute w-full flex justify-between p-4 items-center">
      <h1 className="text-black font-bold text-4xl z-20">Experiences</h1>
      <HiMenuAlt3
        onClick={handleNav}
      ...
      <div
        className={
          nav
            ? "ease-in duration-100 fixed text-gray-300 left-0 top-0 w-full h-screen bg-black/80 px-4 py-7 flex-col z-10"
